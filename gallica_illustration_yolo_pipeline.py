...
write to fully separate local
directories and Azure prefixes (see "IMPORTANT" above), so it's safe to run
all six concurrently in their own tmux sessions on the same pod:
...
for a pod like an RTX A4000 (16GB) running six small YOLO models
